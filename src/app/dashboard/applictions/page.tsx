    ...
    <main className="min-h-screen text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          {[
            { label: "Total Applied", value: stats.total, icon: "send" },
            { label: "Interviews", value: stats.interviews, icon: "microphone" },
            { label: "Offers", value: stats.offers, icon: "trophy" },
            { label: "Rejected", value: stats.rejected, icon: "xMark" },
          ].map((s) => (
            <div key={s.label} className="bg-[#111827] border border-white/10 rounded-xl p-4 text-center">
              <div className="mb-1 text-slate-400"><Icon name={s.icon as any} className="w-6 h-6 mx-auto" /></div>
